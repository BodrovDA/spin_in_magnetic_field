This program generates tau-> (mu->e nu nu) nu nu decay assuming Belle detector condtions (momentum of tau-lepton in the beam center mass system (CMS) and in the laboratory frame).
